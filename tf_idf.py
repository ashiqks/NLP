...
Original file is located at
    https://colab.research.google.com/drive/1JB3err-BaKXspaWJrY2ETxaW3n4BcxEi
"""
...
tfidf = models.TfidfModel(corpus) # import the tf-idf model class from gensim library
tfidf_list = tfidf[corpus] # converting the bag of words representation to tf-idf table
for tfidfs in tfidf_list: # iterating over each row of the tf-idf table
  print(tfidfs)
